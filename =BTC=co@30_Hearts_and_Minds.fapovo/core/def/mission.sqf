...
if (isServer) then {
    ...
    btc_city_blacklist = ["SBP Armybase","Villa Lamogny","School","Factory Jedan","Factory Dva"];//NAME FROM CFG
...
switch (_p_en) do {
    ...
    case "RHSGREF_FACTION_CHDKZ" : {
		btc_type_units = btc_type_units + ["LOP_ChDKZ_Infantry_Rifleman","LOP_ChDKZ_Infantry_SL","LOP_ChDKZ_Infantry_MG","LOP_ChDKZ_Infantry_Rifleman_2","LOP_ChDKZ_Infantry_Rifleman_3"];
		btc_type_units = btc_type_units - ["rhsgref_ins_rifleman_aks74","rhsgref_ins_rifleman_aksu","rhsgref_ins_machinegunner","rhsgref_ins_militiaman_mosin","rhsgref_ins_rifleman_akm"];
		btc_type_motorized_armed = btc_type_motorized_armed + ["RHS_Mi8MTV3_vdv","RHS_Mi24V_vdv","RHS_Su25SM_vvs"];
    };
};
