...
*/
	[[4791.3,5131.3,0],"NameVillage","Taloqan",200,200,true],
	[[708.952,2634.25,0],"NameVillage","Port Firka",200,200,true],
	[[221.825,1822.2,0],"NameVillage","Camp Zappa",200,200,true],
	[[7418.15,289.329,0],"NameVillage","Depot Lesnik",200,200,true],
	[[6976.58,987.003,0],"NameVillage","Camp Damo",200,200,true],
	[[5708.31,6076.21,0],"Hill","Baglan",200,200,true],
	[[7546.24,6224.27,0],"Hill","Balkh",200,200,true],
	[[6834.88,6190.33,0],"Airport","Kushk",100,100,true],
	[[1330.59,6545.65,0],"Airport","Mlofre",100,100,true],
	[[5443.8,7271.2,0],"Airport","Rustaq",200,200,true]
];
