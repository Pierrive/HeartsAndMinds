...
if (isServer) then {
	...
	btc_fnc_drone = compile preprocessFileLineNumbers "core\fnc\info\reconDrone.sqf";
	...
	btc_fnc_log_createVehicleArsenal = compile preprocessFileLineNumbers "core\fnc\log\createVehicleArsenal.sqf";
...
btc_fnc_recycle_wreck = compile preprocessFileLineNumbers "scripts\recycle_wreck.sqf";
recycle_wreck = compile preprocessFileLineNumbers "scripts\fn_recycle_wreck.sqf";
...
if (!isDedicated) then {
	...
	fnc_ask_reputation = compile preprocessFileLineNumbers "scripts\ask_reputation_scripts.sqf";
