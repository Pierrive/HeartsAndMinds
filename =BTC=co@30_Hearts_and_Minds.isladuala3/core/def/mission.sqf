...
if (isServer) then {
	...
	//btc_vehicles = [];
    btc_vehicles = [btc_veh_1, btc_veh_2, btc_veh_3, btc_veh_4, btc_veh_5, btc_veh_6, btc_veh_7, btc_veh_8, btc_veh_9, btc_veh_10];
...
private _allclasse = [[_p_civ, "IDAP"]] call btc_fnc_civ_class; //Create classes from factions, you can combine factions from the SAME side : [[_p_civ , "btc_ac","LOP_TAK_CIV"]] call btc_fnc_civ_class.
...
_allclasse = [[_p_en, "LOP_BH"], _p_en_AA, _p_en_tank] call btc_fnc_mil_class; //Create classes from factions, you can combine factions like that: [[_p_en , "IND_F"], _p_en_AA, _p_en_tank] call btc_fnc_mil_class;
...
switch (_p_en) do {
    case "LOP_AFR_OPF" : {
        btc_type_motorized_armed = btc_type_motorized_armed  + ["LOP_ChDKZ_ZSU234","rhsgref_ins_ural_Zu23","rhsgref_BRDM2_HQ_ins"] - ["LOP_AFR_OPF_M113_W"];
		btc_type_units = btc_type_units - ["rhsgref_ins_specialist_aa"];
