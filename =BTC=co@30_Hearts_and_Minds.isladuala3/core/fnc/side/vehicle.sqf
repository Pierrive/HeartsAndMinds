...
private _groupSidePatrol = [_pos, 60, 4, _wp_sentry] call btc_fnc_mil_create_group;
private _groupSide = _groupSidePatrol select 0;  
...
[{{deleteVehicle _x} forEach units _groupSide;}, [], 120] call CBA_fnc_waitAndExecute;
