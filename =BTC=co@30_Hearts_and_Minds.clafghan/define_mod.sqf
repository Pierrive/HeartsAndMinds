...
private _items = [
	...
	/*another item*/
	"ItemMap", "B_UavTerminal", "ItemGPS", "I_E_UavTerminal", "TFAR_anprc152", "ItemCompass", "ItemWatch", "ChemicalDetector_01_watch_F", "ACE_Altimeter", "TFAR_microdagr",
