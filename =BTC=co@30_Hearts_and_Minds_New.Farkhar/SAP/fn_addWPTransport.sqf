...
if (_vehicle isKindOf "Air") then {
	...
	{_x action ["eject", vehicle _x]; unassignVehicle _x; [_x] ordergetin false; [_x] allowGetIn false; sleep 0.1} forEach (units _cargoGrp);
	...
	_transport_waypoint_delete setWaypointStatements ["true", "{deleteVehicle _x; sleep 0.1;} forEach crew this + [this]"];
