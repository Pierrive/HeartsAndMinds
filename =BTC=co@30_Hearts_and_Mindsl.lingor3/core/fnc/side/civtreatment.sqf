...
private _groupSidePatrolArray = [_vehpos, 60, 3, _wp_sentry] call btc_fnc_mil_create_group;
private _groupSideHouseArray = [_vehpos, 8, 3, _wp_house] call btc_fnc_mil_create_group;
