...
btc_p_trigger = if (("btc_p_trigger" call BIS_fnc_getParamValue) isEqualTo 1) then {
    "this && !btc_db_is_saving && (false in (thisList apply {_x isKindOf 'Plane'})) && (false in (thisList apply {(_x isKindOf 'Helicopter') && (speed _x > 70)}))"
} else {
...
if (isServer) then {
    ...
    btc_city_blacklist = ["Mefunvo Island"];//NAME FROM CFG
    ...
    //Side
    btc_side_ID = 0;
    btc_side_list = ["supply", "mines", "vehicle", "get_city", "tower", "civtreatment", "checkpoint", "rescue", "hostage", "hack", "kill", "EMP"]; // On ground (Side "convoy" and "capture_officer" are not design for map with different islands. Start and end city can be on different islands.)
    ...
    btc_vehicles = [btc_veh_1, btc_veh_2, btc_veh_3, btc_veh_4, btc_veh_5, btc_veh_6, btc_veh_7, btc_veh_8, btc_veh_10, btc_veh_11, btc_veh_12, btc_veh_13, btc_veh_14, btc_veh_15, btc_veh_16, btc_veh_17, btc_veh_18, btc_veh_19, btc_veh_20, btc_veh_21];
    btc_helo = [btc_helo_1];
	missionNamespace setVariable ["ArrayVehNoRespawn", btc_vehicles, true];
	missionNamespace setVariable ["ArrayVehRespawn", btc_helo, true];
...
switch (_p_en) do {
    ...
    case "CUP_O_SLA" : {
		btc_type_units = btc_type_units - ["CUP_O_sla_Soldier_AAT_militia", "CUP_O_sla_Soldier_AMG_militia", "CUP_O_sla_Soldier_AR_militia", "CUP_O_SLA_Soldier_Backpack_militia", "CUP_O_sla_Engineer_militia", "CUP_O_sla_Soldier_GL_militia", "CUP_O_sla_Soldier_MG_militia", "CUP_O_sla_Medic_militia", "CUP_O_sla_Soldier_AA_militia", "CUP_O_sla_Officer_militia", "CUP_O_sla_Soldier_SL_militia", "CUP_O_sla_Soldier_militia", "CUP_O_sla_Soldier_LAT_militia", "CUP_O_sla_Soldier_AT_militia", "CUP_O_sla_Soldier_AA_urban", "CUP_O_sla_Soldier_AAT_urban", "CUP_O_sla_Soldier_AMG_urban", "CUP_O_sla_Soldier_HAT_urban", "CUP_O_sla_Soldier_SL_urban", "CUP_O_sla_Commander_urban", "CUP_O_sla_Soldier_AR_urban", "CUP_O_sla_Soldier_urban", "CUP_O_sla_Soldier_GL_urban", "CUP_O_sla_Soldier_MG_urban", "CUP_O_sla_Medic_urban", "CUP_O_sla_Officer_urban", "CUP_O_SLA_Spotter_urban", "CUP_O_SLA_Soldier_Backpack_urban", "CUP_O_sla_Soldier_LAT_urban", "CUP_O_sla_Soldier_AT_urban", "CUP_O_sla_Engineer_urban", "CUP_O_sla_Sniper_urban", "CUP_O_sla_Sniper_KSVK_urban", "CUP_O_SLA_Sniper_SVD_Night_urban", "CUP_O_sla_Soldier_AKS_Night_urban", "CUP_O_sla_Soldier_AKS_74_GOSHAWK_urban", "CUP_O_sla_Soldier_AA_desert", "CUP_O_sla_Soldier_AAT_desert", "CUP_O_sla_Soldier_AMG_desert", "CUP_O_sla_Soldier_HAT_desert", "CUP_O_sla_Soldier_SL_desert", "CUP_O_sla_Commander_desert", "CUP_O_sla_soldier_desert", "CUP_O_sla_Soldier_AR_desert", "CUP_O_sla_Soldier_GL_desert", "CUP_O_sla_Soldier_MG_desert", "CUP_O_sla_Medic_desert", "CUP_O_sla_Officer_desert", "CUP_O_SLA_Spotter_desert", "CUP_O_SLA_Soldier_Backpack_desert", "CUP_O_sla_Soldier_LAT_desert", "CUP_O_sla_Soldier_AT_desert", "CUP_O_sla_Engineer_desert", "CUP_O_sla_Sniper_desert", "CUP_O_sla_Sniper_KSVK_desert", "CUP_O_SLA_Sniper_SVD_Night_desert", "CUP_O_sla_Soldier_AKS_Night_desert", "CUP_O_sla_Soldier_AKS_74_GOSHAWK_desert", "CUP_O_sla_Commander", "CUP_O_sla_Crew", "CUP_O_sla_Pilot"];
        btc_type_motorized = btc_type_motorized - ["CUP_O_UH1H_SLA", "CUP_O_UH1H_slick_SLA","CUP_O_Volha_SLA", "CUP_O_Tractor_SLA", "CUP_O_UAZ_Militia_SLA"];
		btc_type_motorized_armed = btc_type_motorized_armed - ["CUP_O_UH1H_armed_SLA","CUP_O_UH1H_gunship_SLA"];
    };
    case "IND_C_F" : {
