...
[{!isNull player}, {
	...
	player addEventHandler ["Respawn",{[] execVM "scripts\respawnPierrive.sqf"}];
	
	//Vue limité;
	[] execVM "scripts\CAM_switcher.sqf";
	player addEventHandler["Respawn",{execVM "scripts\CAM_switcher.sqf"}];
