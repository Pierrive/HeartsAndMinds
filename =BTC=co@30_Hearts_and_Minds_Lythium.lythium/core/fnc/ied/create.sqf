...
if !(_active) exitWith {
    [_wreck,["Delete object suspicion",{params ["_target", "_caller", "_actionId", "_arguments"]; deleteVehicle _target},[],1.5,true,true,"","true",3,false,"",""]] remoteExec ["addaction",0,true];
    [_wreck, _garbage, objNull]
};
