...
private _allfaction = ["UK3CB_TKA_O"]; //All factions
...
btc_type_air = _allclasse select 9;								   
...
switch (_p_en) do {
    case "UK3CB_TKA_O" : {
        ...
        btc_type_gl = btc_type_gl + ["UK3CB_TKA_O_D30", "UK3CB_TKA_O_Igla_AA_pod", "UK3CB_TKA_O_ZU23"] - ["UK3CB_TKA_O_AGS", "UK3CB_TKA_O_2b14_82mm"];
        btc_type_units = btc_type_units - ["UK3CB_TKA_O_STATIC_GUN_AGS30", "UK3CB_TKA_O_STATIC_TRI_AGS30", "UK3CB_TKA_O_STATIC_GUN_PODNOS", "UK3CB_TKA_O_STATIC_TRI_PODNOS"];
		btc_type_motorized = btc_type_motorized - ["UK3CB_TKA_O_Antonov_AN2"];
	};
    case "OPF_G_F" : {
