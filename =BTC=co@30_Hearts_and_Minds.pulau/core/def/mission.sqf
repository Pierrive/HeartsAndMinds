...
if (isServer) then {
    ...
    btc_vehicles = [btc_M113A3, btc_M113_MG, btc_Humvee, btc_Humvee_MG, btc_Hunter, btc_M1A1, btc_M1A2, btc_Truck_Bache, btc_Truck_Bache_2, btc_Truck, btc_Truck_Ammo, btc_Truck_Fuel, btc_Truck_Repair, btc_UH60_Med, btc_UH60, btc_AH1Z, btc_AH64, btc_MkV_Boat, btc_Minigun_Boat];
    btc_helo = [btc_CH47, btc_F22, btc_FA18_Furtif, btc_MH6, btc_UH1Y_MG];
