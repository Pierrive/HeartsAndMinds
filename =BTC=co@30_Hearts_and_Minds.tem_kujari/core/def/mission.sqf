...
private _allclasse = [[_p_civ, "mas_afr_civ"]] call btc_fnc_civ_class; //Create classes from factions, you can combine factions from the SAME side : [[_p_civ , "btc_ac","LOP_TAK_CIV"]] call btc_fnc_civ_class.
...
private _allfaction = ["BLU_F","BLU_G_F","CHMODS","IND_F","IND_G_F","OPF_F","OPF_G_F","BLU_GEN_F","BLU_T_F","BLU_CTRG_F","IND_C_F","OPF_T_F","FR2035_F","MAS_FRA_AMULTI","MAS_FRA_CAOR1","MAS_FRA_DAOR2","MAS_FRA_EWINT","MAS_FRA_GSPEC","MAS_FRA_IDIVER","MAS_FRA_JPARAS","MAS_FRA_KSWAT","MAS_FRA_LLEG","LOP_AA","LOP_AFR","LOP_AFR_OPF","LOP_AM","LOP_AM_OPF","LOP_BH","LOP_CDF","LOP_CHDKZ","LOP_IA","LOP_IRA","LOP_IRAN","LOP_ISTS","LOP_ISTS_OPF","LOP_NAPA","LOP_PESH","LOP_PESH_IND","LOP_PMC","LOP_RACS","LOP_SLA","LOP_TKA","LOP_UA","LOP_UKR","LOP_UN","LOP_US","LOP_UVF","MAS_AFR_BLUR","MAS_AFR_BLUR_HD","MAS_AFR_IND","MAS_AFR_IND_HD","MAS_AFR_INDR","MAS_AFR_INDR_HD","MAS_AFR_ONU","MAS_AFR_ONU_HD","MAS_AFR_OPF","MAS_AFR_OPF_HD","RHS_FACTION_MSV","RHS_FACTION_RVA","RHS_FACTION_TV","RHS_FACTION_VDV","RHS_FACTION_VMF","RHS_FACTION_VPVO","RHS_FACTION_VV","RHS_FACTION_VVS","RHS_FACTION_VVS_C","RHSGREF_FACTION_CDF_AIR","RHSGREF_FACTION_CDF_AIR_B","RHSGREF_FACTION_CDF_GROUND","RHSGREF_FACTION_CDF_GROUND_B","RHSGREF_FACTION_CDF_NG","RHSGREF_FACTION_CDF_NG_B","RHSGREF_FACTION_CHDKZ","RHSGREF_FACTION_CHDKZ_G","RHSSAF_FACTION_AIRFORCE","RHSSAF_FACTION_ARMY","RHSSAF_FACTION_UN","RHS_FACTION_SOCOM","RHS_FACTION_USAF","RHS_FACTION_USARMY_D","RHS_FACTION_USARMY_WD","RHS_FACTION_USMC_D","RHS_FACTION_USMC_WD","RHS_FACTION_USN","RHSGREF_FACTION_HIDF","RHSGREF_FACTION_NATIONALIST","RHSGREF_FACTION_UN","VSM_GP"]; //All factions
_p_en = _allfaction select _p_en; //Select faction selected from mission parameter
_allclasse = [[_p_en, "LOP_AFR_OPF"], _p_en_AA, _p_en_tank] call btc_fnc_mil_class; //Create classes from factions, you can combine factions like that: [[_p_en , "IND_F"], _p_en_AA, _p_en_tank] call btc_fnc_mil_class;
